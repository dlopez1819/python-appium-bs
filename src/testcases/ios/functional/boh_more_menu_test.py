...
class TestBoHMoreMenu(Driver):
    ...
    def test_boh_more_menu_terms_of_use_BOH19_TC536(self, test_email, test_pwd):
    ...
    @pytest.mark.functional
    @pytest.mark.parametrize('test_email, test_pwd', Account.BoHCredentials)
    def test_boh_more_menu_disclaimers_BOH19_TC539(self, test_email, test_pwd):
    ...
    @pytest.mark.functional
    @pytest.mark.parametrize('test_email, test_pwd', Account.BoHCredentials)
    def test_boh_more_menu_faqs_BOH19_TC541(self, test_email, test_pwd):
    ...
    @pytest.mark.functional
    @pytest.mark.parametrize('test_email, test_pwd', Account.BoHCredentials)
    def test_boh_more_menu_off_roading_101_BOH19_TC2594(self, test_email, test_pwd):
    ...
    @pytest.mark.functional
    @pytest.mark.parametrize('test_email, test_pwd', Account.BoHCredentials)
    def test_boh_more_menu_announcements_BOH19_TC2595(self, test_email, test_pwd):
    ...
    @pytest.mark.functional
    @pytest.mark.parametrize('test_email, test_pwd', Account.BoHCredentials)
    def test_boh_more_menu_suggest_a_trail_BOH19_TC2596(self, test_email, test_pwd):
    ...
    @pytest.mark.functional
    @pytest.mark.parametrize('test_email, test_pwd', Account.BoHCredentials)
    def test_boh_more_menu_earn_a_badge_BOH19_TC2597(self, test_email, test_pwd):
